...
Another improvement would be had with the use of paging - only make calls for those items that are visible on the page, and maybe a couple more, then as you begin scrolling, keep pulling until you've hit the upper limit
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MDY4ODQ4LDk4Mzg1OTA3NiwyNTM2MT
Y5M119
-->